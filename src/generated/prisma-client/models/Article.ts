...
export type ArticleWhereInput = {
  ...
  id_article?: Prisma.StringFilter<"Article"> | string
...
export type ArticleScalarWhereWithAggregatesInput = {
  ...
  id_article?: Prisma.StringWithAggregatesFilter<"Article"> | string
...
export type ArticleUpdateInput = {
  id_article?: Prisma.StringFieldUpdateOperationsInput | string
...
export type ArticleOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id_article" | "title" | "category" | "content", ExtArgs["result"]["article"]>
...
export interface ArticleDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many Articles and only return the `id_article`
   * const articleWithId_articleOnly = await prisma.article.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Articles and only return the `id_article`
   * const articleWithId_articleOnly = await prisma.article.updateManyAndReturn({
   *   select: { id_article: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ArticleFieldRefs {
  readonly id_article: Prisma.FieldRef<"Article", 'String'>
